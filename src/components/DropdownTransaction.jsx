...
function DropdownTransaction({ align }) {
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className={`absolute top-full z-10 mt-1 min-w-44 origin-top-right overflow-hidden rounded-lg border border-gray-200 bg-white py-1.5 shadow-lg dark:border-gray-700/60 dark:bg-gray-800 ${
