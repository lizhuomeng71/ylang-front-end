...
function DropdownNotifications({ align }) {
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className={`absolute top-full z-10 mt-1 -mr-48 min-w-80 origin-top-right overflow-hidden rounded-lg border border-gray-200 bg-white py-1.5 shadow-lg sm:mr-0 dark:border-gray-700/60 dark:bg-gray-800 ${align === 'right' ? 'right-0' : 'left-0'}`}
        show={dropdownOpen}
