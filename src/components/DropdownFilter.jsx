  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className={`absolute top-full right-auto left-0 z-10 mt-1 min-w-56 origin-top-right overflow-hidden rounded-lg border border-gray-200 bg-white pt-1.5 shadow-lg dark:border-gray-700/60 dark:bg-gray-800 ${
          align === 'right'
