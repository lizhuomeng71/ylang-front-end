...
function AnalyticsCard01() {
  ...
  return (
    <div className="col-span-full flex flex-col rounded-xl bg-white shadow-xs xl:col-span-8 dark:bg-gray-800">
      ...
      <div className="px-5 py-1">
        <div className="flex flex-wrap max-sm:*:w-1/2">
          ...
          <div className="flex items-center py-2">
            ...
            <div
              className="mr-5 hidden h-8 w-px bg-gray-200 md:block dark:bg-gray-700"
              aria-hidden="true"
            ></div>
          </div>
          {/* Total Pageviews */}
