        ...
        <section>
          ...
          <div>
            ...
            <div className="grid grid-cols-12 gap-6">
              {/* Tab 1 */}
              <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-xs xl:col-span-4 dark:border-gray-700/60 dark:bg-gray-800">
                <div
                  className="absolute top-0 right-0 left-0 h-0.5 bg-green-500"
                  aria-hidden="true"
                ></div>
              ...
              <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-xs xl:col-span-4 dark:border-gray-700/60 dark:bg-gray-800">
                <div
                  className="absolute top-0 right-0 left-0 h-0.5 bg-sky-500"
                  aria-hidden="true"
                ></div>
                <div className="border-b border-gray-200 px-5 pt-5 pb-6 dark:border-gray-700/60">
                  <header className="mb-2 flex items-center">
              ...
              <div className="relative col-span-full rounded-b-lg border border-gray-200 bg-white shadow-xs xl:col-span-4 dark:border-gray-700/60 dark:bg-gray-800">
                <div
                  className="absolute top-0 right-0 left-0 h-0.5 bg-violet-500"
                  aria-hidden="true"
                ></div>
                <div className="border-b border-gray-200 px-5 pt-5 pb-6 dark:border-gray-700/60">
                  <header className="mb-2 flex items-center">
