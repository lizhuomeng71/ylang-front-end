...
function InvoicesTableItem(props) {
  ...
  return (
    <tr>
      ...
      <td className="px-2 py-3 whitespace-nowrap first:pl-5 last:pr-5">
        <div
          className={`inline-flex rounded-full px-2.5 py-0.5 text-center font-medium ${statusColor(props.status)}`}
        >
          {props.status}
        </div>
      </td>
      ...
      <td className="w-px px-2 py-3 whitespace-nowrap first:pl-5 last:pr-5">
        <div className="space-x-1">
          ...
          <button className="rounded-full text-red-500 hover:text-red-600">
