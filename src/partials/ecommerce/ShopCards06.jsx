...
function ShopCards06() {
  return (
    <React.Fragment>
      {/* Card 1 */}
      <div className="relative col-span-full overflow-hidden rounded-xl bg-white shadow-xs sm:col-span-6 xl:col-span-3 dark:bg-gray-800">
        {/* Image */}
        <img
        ...
        <div className="relative flex h-full flex-col justify-end p-5">
          <h3 className="mt-16 mb-0.5 text-lg font-semibold text-white">
            Merchandise
          </h3>
          <a
