                        ...
                        <div className="flex space-x-4 p-5">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap justify-end space-x-2">
                              ...
                              <button className="btn-sm bg-red-500 text-white hover:bg-red-600">
                                Yes, Delete it
                              </button>
                            </div>
                          </div>
                        ...
                        <div className="px-5 pt-4 pb-1">
                          <div className="text-sm">
                                    ...
                                    <div className="grow">
                                      <div className="mb-0.5 flex flex-wrap items-center justify-between">
                                        <span className="font-medium text-gray-800 dark:text-gray-100">
                                          Mosaic Light{' '}
                                          <span className="align-top text-xs text-gray-500 italic">
                                            Current Plan
                                          </span>
                                        </span>
                            ...
                            <div className="text-xs text-gray-500">
                              ...
                              per month and will renew on August 9, 2024.
                            </div>
                          </div>
                        </div>
                        {/* Modal footer */}
